              ...
              <tbody>
                ...
                {insurance.map(i => {
                  ...
                  return <tr key={i.id} style={{ borderBottom:'1px solid rgba(0,0,0,0.05)' }}>
                    ...
                    <td style={{ padding:'12px 16px' }}><span style={{ padding:'3px 10px', borderRadius:99, fontSize:'0.72rem', fontWeight:700, background:valid?'#dcfce7':'#fee2e2', color:valid?'#15803d':'#dc2626' }}>{valid?'Active':'Expired'}</span></td>
                  </tr>
                })}
              </tbody>
            </table>
